...
// Displayed in the LCD "Ready" message
	...
	#define CUSTOM_MACHINE_NAME "frenchDICE"
#endif
...
// -erreur compilation   13 is 100k Hisens 3950  1% up to 300°C for hotend "Simple ONE " & "Hotend "All In ONE"
// 20 is the PT100 circuit found in the Ultimainboard V2.x
// 23 sonde pour bicephale (bed)
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Dyze                        //PID STANDARD   //PID SUR RAMPS   //CONSEIL DYZE
  #define  DEFAULT_Kp 24.46      //22.58          //15.52           //14.0
  #define  DEFAULT_Ki 1.08       //0.98           //0.87            //0.5
  #define  DEFAULT_Kd 138.56     //130.08         //69.43           //125.0
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
 ...
 //from BICEPHALE model
    #define  DEFAULT_bedKp 349.66
    #define  DEFAULT_bedKi 46.19
    #define  DEFAULT_bedKd 661.69
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define AUTO_BED_LEVELING_GRID
    ...
    // For Bicephale
    #define LEFT_PROBE_BED_POSITION 27    //27
    #define RIGHT_PROBE_BED_POSITION 190  //190
    #define FRONT_PROBE_BED_POSITION 10  //10
    #define BACK_PROBE_BED_POSITION 190   //190

    #define MIN_PROBE_EDGE 13 // The Z probe minimum square sides can be no smaller than this.
...
#if 0
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,1600,645}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {300, 300, 7, 35}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {1500,1500,100,2000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,1600,645}  // default steps per unit for ST
#define DEFAULT_MAX_FEEDRATE          {300, 300, 7, 55}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {2000,2000,100,1000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
